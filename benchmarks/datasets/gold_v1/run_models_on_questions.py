"""
Run all questions from questions.json against two real Groq models
and save the raw model responses to model_responses.json.
"""
        ...
        for item in items:
            ...
            for lang in ("en", "ar"):
                ...
                for model in MODELS:
                    ...
                    try:
                        answer = ask_model(model["name"], question)
                        status = "ok"
